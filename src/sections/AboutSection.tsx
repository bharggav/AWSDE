  ...
  <SectionContainer id="about">
    ...
    <div className="glass-card space-y-4 p-6">
      <p className="text-slate-700 dark:text-slate-200">
        I am Bharggav Galla, an AWS DATA ENGINEER / ETL Developer with 4.6+ years of experience delivering reliable data platforms, governed data lakes, and analytics-ready datasets.
