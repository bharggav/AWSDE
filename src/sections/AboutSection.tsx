  ...
  <SectionContainer id="about">
    ...
    <div className="glass-card space-y-4 p-6">
      <p className="text-slate-700 dark:text-slate-200">
        Results-driven AWS Data Engineer / ETL Developer with 6+ years of experience delivering reliable data platforms, governed data lakes, and analytics-ready datasets.
      </p>
