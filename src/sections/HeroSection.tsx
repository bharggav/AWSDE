  ...
  <SectionContainer id="hero" className="pt-36">
    <div className="grid items-center gap-10 md:grid-cols-2">
      <div className="space-y-6">
        ...
        <p className="max-w-xl text-slate-300 dark:text-slate-300">
        ...
        <div className="flex gap-4">
          ...
          <a href="/resume.pdf" className="rounded-xl border border-cyan-300 px-5 py-3 font-semibold text-cyan-200 transition hover:bg-cyan-500/10">Download Resume</a>
        </div>
      </div>
      <motion.div
      ...
      >
        ...
        <p className="relative text-lg text-slate-100">Building modern AWS data systems with performance, governance, and scale.</p>
      </motion.div>
    </div>
  </SectionContainer>
);
